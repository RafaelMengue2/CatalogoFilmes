class Ator {
 ...
 class Filme {
    constructor(id, titulo, ano, genero, duracao, cartaz, sinopse,
       direcao, elenco, classificacao, avaliacao) {
       this.id = id;
       this.titulo = titulo;
       this.ano = ano;
       this.genero = genero;
    ...
    setBtnDetalhes = () => {
       ...
       this.btnDetalhes.appendChild(document.createTextNode(
          "Detalhes"));
    ...
    setBtnSalvar = () => {
       ...
       this.btnSalvar.appendChild(document.createTextNode(
          "Salvar"));
    ...
    setBtnExcluir = () => {
       ...
       this.btnExcluir.appendChild(document.createTextNode(
          "Excluir"));
    ...
    getCard = (tipo) => {
       ...
       card.setAttribute("class",
          "card justify-content-around col mb-10");
       ...
       hCardTitle.setAttribute("class",
          "card-title text-center text-break fs-5 text");
       let divDetalhes = document.createElement("div");
       divDetalhes.setAttribute("style",
       ...
       divAnoProducao.appendChild(document.createTextNode(this
          .ano));
       divClassificacao.appendChild(document.createTextNode(this
          .classificacao));
    ...
    getDetalhes = () => {
       ...
       divDuracao.appendChild(document.createTextNode("Duration: " +
          this.duracao));
       divClassificacao.appendChild(document.createTextNode(
          "Rated: " + this.classificacao));
       divAvaliacao.appendChild(document.createTextNode("Rating: " +
          this.avaliacao));
       divGeneros.appendChild(document.createTextNode("Genres: " +
          this.genero));
       divDirecao.appendChild(document.createTextNode("Director: " +
          this.direcao));
       divElenco.appendChild(document.createTextNode("Cast: " + this
          .elenco));
